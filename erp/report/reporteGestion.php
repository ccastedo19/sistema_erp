...
<body>
    <nav>
        ...
        <div class="tertituloNav">
            ...
            <img class="flecha_gris"src="../img/flecha_derecha_gris.png">
            <span class="Nombre_Reporte">reporteGestion</span> <!--Este el nombre del reporte puede ser cambiado-->
        </div>
        <div class="contenido-funciones">
            ...
            <div class="container">
                ...
                <div class="impresora">
                    ...
                    <a href="#" onclick="showPdfPreview('gestiones/pdf_preview_gestion.php?id_empresa=<?php echo $id_empresa; ?>')"><img class="imprimir" src="../img/impresora.png"></a>
                    <hr class="vertical-line">
                </div>
                    ...
                    <table  cellpadding="5" width="100%">
                        <tbody style="position:relative;bottom:50px;">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<tr>";
                                echo "<td style='text-align:center;'>{$row['nombre_gestion']}</td>";
                                echo "<td style='text-align:center;'>" . date('d/m/Y', strtotime($row['fecha_inicio'])) . "</td>";
                                echo "<td style='text-align:center;'>" . date('d/m/Y', strtotime($row['fecha_fin'])) . "</td>";
