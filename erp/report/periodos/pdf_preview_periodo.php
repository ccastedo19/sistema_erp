...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $html .= "<tr>";
    $html .= "<td style='text-align:center;' >{$row['nombre_periodo']}</td>";
    $html .= "<td style='text-align:center;'>" . date('d/m/Y', strtotime($row['fecha_inicio_periodo'])) . "</td>";
    $html .= "<td style='text-align:center;'>" . date('d/m/Y', strtotime($row['fecha_fin_periodo'])) . "</td>";
