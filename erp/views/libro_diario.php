                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="padding:55px;">
                        <div class="formularioBalance"> 
                            <h2 class="tituloBalance">Libro Diario</h2>
                            <div class="contenForm">
                                <form class="formReport" method="POST" action="../report/reporteLibroDiario.php?id_empresa=<?php echo $id_empresa ?>" target="_blank">
                                    <div class="form-group ContainerGestion">
                                        ...
                                        if (mysqli_num_rows($result) == 0) {?>
                                            <span style="color:#fff;font-size:20px;" >No se encontraron resultados de Gestiones en la empresa,<br>por lo tanto no es posible relizar un reporte del Libro Diario</span>
                                            <style>
                                    ...
                                    <div class="form-group ContainerPeriodo" id="select2lista"></div>

                                    <div class="form-group ContainerMoneda">
                                    <?php
                                        include_once '../../erpApi/conexion/bd_directa.php';
                                        $query = "
                                            SELECT
