            ...
            <div id="content">
                ...
                <div class="card shadow mb-4" >
                    ...
                    <div class="parteFuncional">
                        ...
                        <div class="parteDerechaOff">
                            <div>
                                <?php
                                    if($estado_nota == 1){?>
                                        <button style="background-color:#000;"  title="Anular" type="button" onclick="editarNota(<?php echo $id_nota; ?>,<?php echo $id_empresa ?>, event)" class="btn btn-dark">Anular</button> 
                                    <?php
                                    }else{?>
                            ...
                            <div>
                            <a title="Reporte" target="_blank" style="" class="btn btn-primary" href="../report/reporteNotaCompra.php?id_empresa=<?php echo $id_empresa ?>&id_nota=<?php echo $id_nota?>"><span>Reporte </span><i class="fas fa fa-print" aria-hidden="true"></i></a>
                            </div>
                            <a href="notaCompraDetalle.php?id=<?php echo $id_empresa; ?>" class="btn btn-success">Nuevo</a>
                        </div>
                    </div>
                    ...
                    <?php
                        ...
                        //consulta
                        $sqlCliente = "SELECT l.*, na.nombre_articulo
                            FROM lotes AS l
                        ...
                        <table class="table" id="tablaDetalles">
                            ...
                            <?php
                                if ($queryNota -> num_rows > 0){
                                    $total = 0; // Agregar una variable para almacenar el total
                                    while ($dataNota = mysqli_fetch_array($queryNota)) {  
                                        $subtotal = $dataNota['cantidad_lote'] * $dataNota['precio_compra'];
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="width:8rem;">
                                        <?php
                                        $fechaVencimiento = $dataNota['fecha_vencimiento'];

                                        if ($fechaVencimiento === '0' || empty($fechaVencimiento)) {
                                            echo '';
                                        } else {
                                    ...
                                    <td style="width:5rem;text-align:right"><?php echo $dataNota['cantidad_lote'] ?></td>
                                    <td style="width:5rem;text-align:right"><?php echo $dataNota['precio_compra'] ?></td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td style="width:5rem;text-align:right"><?php echo $total; ?></td>
                                </tr>
                            </tfoot>
