...
if (mysqli_num_rows($result) == 0) {?>
    <span style="color:#fff;font-size:20px;" >No se encontraron resultados de Periodos en la empresa,<br>por lo tanto no es posible relizar un reporte del Libro Mayor</span>
    <style>
