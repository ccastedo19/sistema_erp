...
<style>
    ...
    .select2-container .select2-selection--single {
        height: 40px; /* Altura que desees */
        border: 1px solid #d1d3e2;
    }

    .select2-container--default .select2-selection--single .select2-selection__rendered {
        line-height: 40px; /* Altura que desees */
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="padding:55px;">
                        <div class="formularioBalance"> 
                            <h2 class="tituloBalance">Articulos de Bajo Stock</h2>
                            <div class="contenForm">
                                <form class="formReport" method="POST" action="../report/reporteArticuloStock.php?id_empresa=<?php echo $id_empresa; ?>" target="_blank">
                                
                                    <div class="ContainerGestion form-group">
                                        <span class="textBalance txtGestion">Seleccionar Categoría</span>
                                        <?php
                                        include_once '../../erpApi/conexion/bd_directa.php';

                                        $qry = "SELECT id_categoria, nombre_categoria FROM categorias WHERE id_empresa_categoria = '$id_empresa'";

                                        $result = mysqli_query($conexion, $qry);

                                        if (mysqli_num_rows($result) == 0) {?>
                                            <span style="color:#fff;font-size:20px;" >No se encontraron resultados de categorias en la empresa,<br>por lo tanto no es posible relizar un reporte de articulos bajo stock</span>
                                            <style>
                                        ...
                                        <select name="selectCategoria" id="selectCategoria" class="form-control select2">
                                            <?php
                                    ...
                                    <div class="ContainerMoneda form-group">
                                        <span class="textBalance txtGestion">Cantidad</span>
                                        <input type="number" class="form-control no-arrow" name="selectCantidad" id="selectCantidad" min="1" required>
                                    </div>
