            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="padding:55px;">
                        <div class="formularioBalance"> 
                            <h2 class="tituloBalance">Libro Mayor</h2>
                            <div class="contenForm">
                                <form class="formReport" method="POST" action="../report/reporteLibroMayor.php?id_empresa=<?php echo $id_empresa; ?>" target="_blank">
                                    <div class="ContainerGestion form-group">
                                        ...
                                        if (mysqli_num_rows($result) == 0) {?>
                                            <span style="color:#fff;font-size:20px;" >No se encontraron resultados de Gestiones en la empresa,<br>por lo tanto no es posible relizar un reporte del Libro Mayor</span>
                                            <style>
                                    ...
                                    <div class="ContainerPeriodo form-group" id="select2lista"></div>
                ...
                <script type="text/javascript">
                    function recargarLista() {
                        $.ajax({
                            type: "POST",
                            url: "datos/get_periodos2.php",
                            data: "id_gestion=" + $('#Selectgestion').val(),
                            success: function (r) {
                                $('#select2lista').html(r);
                            }
                        });
