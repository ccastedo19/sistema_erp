                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="padding:55px;">
                        <div class="formularioBalance"> 
                            <h2 class="tituloBalance">Comprobación de Sumas y Saldos</h2>
                            <div class="contenForm">
                                <form class="formReport" method="POST" action="../report/reporteSumaSaldo.php?id_empresa=<?php echo $id_empresa ?>" target="_blank">
                                    <div class="form-group ContainerGestion">
                                        ...
                                        if (mysqli_num_rows($result) == 0) {?>
                                            <span style="color:#fff;font-size:20px;" >No se encontraron resultados de Gestiones en la empresa,<br>por lo tanto no es posible relizar un reporte de Sumas y Saldos</span>
                                            <style>
                                    ...
                                    <div>
                                        <button class="form-group botonBalance" type="submit" ><span>Obtener Reporte<span></button>
                                    </div>
                                </form>
                            </div>
