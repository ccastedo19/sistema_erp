...
<script>    
    ...
    $('#formularioEdit').submit(function(event) {
        ...
        var id_gestion = $('#id_gestion_').val();
        var nombre_gestion = $('#nombre_gestion_').val();
        var fecha_inicio = $('#fecha_inicio_').val();
        var fecha_fin = $('#fecha_fin_').val();
        var estado_gestion = $('#estado_gestion_').val();
        var id_empresa_gestion = $('#id_empresa_gestion_').val();
        var id_usuario_gestion = $('#id_usuario_gestion_').val();
        //enviar datos a funcion
        actualizarGestion(id_gestion,nombre_gestion,fecha_inicio,fecha_fin,estado_gestion,id_empresa_gestion,id_usuario_gestion,event);
        ...
        $.ajax({
            ...
            data: {
                ...
                id_empresa_gestion: id_empresa_gestion,
                id_usuario_gestion: id_usuario_gestion
            },
...
<?php
    ...
    $sqlCliente   = ("SELECT * FROM gestiones WHERE id_empresa_gestion = $id_empresa");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="ImagenAutor">
                        <div>
                            <img class="FotoAutor"src="../img/calendar_book.png">
                        </div>
                        <div>
                            <h2 style="font-size:47px; margin-top:2.5rem;" class="txtDichoAutor">Gestiones de <?php echo $nombre_empresa; ?></h2>
                        </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="arribaTbl">
                        ...
                        <div style="display:flex; flex-direction:row;" class="anadir">
                            <div class="reporte">
                                <a style="position:relative; right:10.5rem;" href="../report/reporteGestion.php?id_empresa=<?php echo $id_empresa; ?>" class="btn btn-primary" role="button" target="_blank">Reporte  <i class="fas fa fa-print" aria-hidden="true"></i></a>
                            </div>
                            <div class="anadirG">
                                <?php
                                    include_once '../../erpApi/conexion/bd_directa.php';
                                    $sql = "SELECT COUNT(DISTINCT id_gestion) AS cantidad_gestiones FROM gestiones WHERE id_empresa_gestion = '$id_empresa' AND estado_gestion != 0";
                                    $resultado = mysqli_query($conexion, $sql);
                                    $row = mysqli_fetch_assoc($resultado);
                                    if($row['cantidad_gestiones'] < 2){?>
                                        <button style="position:relative;right:-53px;" type="button" class="btn btn-success añadir" data-toggle="modal" data-target="#exampleModal2" data-whatever="@mdo">Añadir Gestion</button>
                                    <?php
                                    }else{?>
                                        <button style="position:relative;right:-53px;" title="Solo 2 Gestiones Máx." type="button" <?php echo 'disabled'; ?> class="btn btn-success añadir">Añadir Gestion</button> 
                                    <?php
                                    }
                                ?>
                    ...
                    <?php
                        ...
                        if(isset($_GET['enviar'])){
                          ...
                          if (isset($_GET['busqueda']))
                          {
                            $where = "WHERE (gestiones.nombre_gestion LIKE '%".$busqueda."%' OR fecha_inicio LIKE '%".$busqueda."%' OR fecha_fin LIKE '%".$busqueda."%') AND id_empresa_gestion = $id_empresa";
                            //consulta
                            $sqlCliente   = ("SELECT * FROM gestiones $where");
                            $queryGestion = mysqli_query($con, $sqlCliente);
                            $cantidad     = mysqli_num_rows($queryGestion);?>
                                    <style>
                                        .paginacion{
                                            display:none;
                                        }
                                ...
                                if($_GET['busqueda'] == ''){
                                    header('Location:gestiones.php?paginas=1');
                                }
                                ...
                                //echo $iniciar;
                                //consulta
                                $sqlCliente   = ("SELECT * FROM gestiones WHERE id_empresa_gestion = $id_empresa ORDER BY id_gestion DESC LIMIT $iniciar,5");
                                $queryGestion = mysqli_query($con, $sqlCliente);
                                $cantidad     = mysqli_num_rows($queryGestion);
                    ...
                    <thead style="background-color:#5a5c69; color:#fff;">
                        ...
                        <?php
                            if ($queryGestion -> num_rows > 0){
                                while ($dataGestion = mysqli_fetch_array($queryGestion)) {  
                        ?>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="width:18rem;"><?php echo $dataGestion['nombre_gestion']; ?></td>
                            <td style="width:10rem;"><?php echo date('d/m/Y', strtotime($dataGestion['fecha_inicio'])); ?></td>
                            <td style="width:10rem;"><?php echo date('d/m/Y', strtotime($dataGestion['fecha_fin'])); ?></td>
                
                            <td style="width:15rem;">
                                <?php
                                if($dataGestion['estado_gestion'] == 1){ ?>
                                ...
                                <?php
                                }else if($dataGestion['estado_gestion'] == 0){ ?>
                            ...
                            <td style="width:15rem;">
                                <!--SIN USO TODAVIA-->
                                <?php if($dataGestion['estado_gestion'] >= 1){?>
                                    <button title="Eliminar Gestión" style="background-color:#e74a3b; border-color:#e74a3b" title="Eliminar"  type="button" class="btn btn-info" onclick="eliminarGestion(<?php echo $dataGestion['id_gestion']; ?>)" >
                                        <i class="fas fa fa-trash" aria-hidden="true"></i>
                                    </button>

                                    <button type="button" title="Editar Gestión" class="btn btn-info" data-toggle="modal" data-target="#formEditar" data-whatever="@mdo" data-id="<?php echo $dataGestion['id_gestion']; ?>" data-gestion='<?php echo json_encode($dataGestion); ?>'>
                                        <i class="fas fa fa-edit" aria-hidden="true"></i>
                                    </button>

                                    
                                    <!--Ventana Modal para la Alerta de Editar--->
                                    <?php include('../../erpApi/conexion/bd.php');//abrimos la conexion ?> 
                                    <div class="modal fade" id="formEditar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header" style="background-color:#17a2b8">
                                            <h5 class="modal-title" id="exampleModalLabel" style="color:#fff;">Editar Gestión</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>
                                            ...
                                            <div style="display:none;" class="form-group col-12">
                                                ...
                                                <input type="text" class="form-control inputAgregar" id="id_gestion_" name="id_gestion_" required value="<?php echo $dataGestion['id_gestion'] ?>">
                                                <div class="invalid-feedback d-none">
                                                    Campo Obligatorio
                                                </div>
                                            </div>
                                                <div class="form-group col-12">
                                                    <label style="position:relative; right:8.9rem;" for="validationCustom01" class="col-form-label">Nombre de la Gestión</label>
                                                    <input type="text" class="form-control inputAgregar" id="nombre_gestion_" name="nombre_gestion_" required value="<?php echo $dataGestion['nombre_gestion'] ?>">
                                                    <div class="invalid-feedback d-none">
                                                        Campo Obligatorio
                                                    </div>
                                                </div>
                                                <div class="form-group col-12">
                                                    <label style="position:relative; right:10.4rem;" for="fecha_inicio" class="col-form-label">Fecha De Inicio</label>
                                                    <input type="date" class="form-control inputAgregar" id="fecha_inicio_" name="fecha_inicio_" required value="<?php echo $dataGestion['fecha_inicio'] ?>">
                                                    <div class="invalid-feedback d-none">
                                                        Campo Obligatorio
                                                    </div>
                                                </div>
                                                <div class="form-group col-12">
                                                    <label style="position:relative; right:8.9rem;" for="fecha_fin" class="col-form-label">Fecha De Finalización</label>
                                                    <input type="date" class="form-control inputAgregar" id="fecha_fin_" name="fecha_fin_" required value="<?php echo $dataGestion['fecha_fin'] ?>"
                                                ...
                                                <div style="display:none;" class="form-group col-12">
                                                    <label for="estado_gestion" class="col-form-label">estado</label>
                                                    <input type="number" class="form-control inputAgregar" id="estado_gestion_" name="estado_gestion_" required="true" value="1" readonly>
                                                </div>  
                                                <div style="display:none;" class="form-group col-12">
                                                    <label for="id_usuario_gestion" class="col-form-label">usuario gestion</label>
                                                    <input type="number" class="form-control inputAgregar" id="id_usuario_gestion_" name="id_usuario_gestion_" required="true" value="1" readonly>
                                                </div>
                                                <div style="display:none;" class="form-group col-12">
                                                    <label for="id_empresa_gestion" class="col-form-label">id de la empresa</label>
                                                    <input type="number" class="form-control inputAgregar" id="id_empresa_gestion_" name="id_empresa_gestion_" required="true" value="<?php echo $dataGestion['id_empresa_gestion'] ?>" readonly>
                                                </div>
                                                <div class="modal-footer">
                                    ...
                                    <a href="periodos.php?id=<?php echo $dataGestion['id_gestion'];?>&paginas=1" title="Ver Periodos" class="btn btn-success">
                                        <i class="far fa-calendar-alt" aria-hidden="true"></i>
                                    </a>
                                    
                                <?php
                                }else{?>
                                    <a style="margin-right:5.8rem;" href="periodos.php?id=<?php echo $dataGestion['id_gestion'];?>&paginas=1" title="Ver Periodos" class="btn btn-success">
                                        <i class="far fa-calendar-alt" aria-hidden="true"></i>
                                    </a>
                                <?php
                                } ?>
                        ...
                        <!--Ventana Modal para la Alerta de Editar--->
                        <!--<?php //include('modal/editarEmpresa.php'); ?>-->
                        ...
                        <nav aria-label="Page navigation example" class="paginacion">
                            <ul class="pagination">
                                <li class="page-item <?php echo $_GET['paginas']<=1? 'disabled':''?>">
                                    <a class="page-link" href="gestiones.php?id=<?php echo $id_empresa?>&paginas=<?php echo $_GET['paginas']-1 ?>">
                                        Anterior
                                    </a>
                                </li>
                                ...
                                <li  class="page-item <?php echo $_GET['paginas']==$i+1 ? 'active' : '' ?>" >
                                    <a style="background-color:#5a5c69; color:white;" class="page-link" href="gestiones.php?id=<?php echo $id_empresa?>&paginas=<?php //echo $i+1 ; ?>">
                    ...
                    <ul class="pagination">
                            <a style="background-color:#5a5c69;border:none;" class="btn btn-secondary btnVolver" href="gestiones.php?id=<?php echo $id_empresa?>&paginas=1">
                                Volver
                            </a>
                    </ul>    
