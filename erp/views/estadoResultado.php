                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="padding:55px;">
                        <div class="formularioBalance"> 
                            <h2 class="tituloBalance">Estado de Resultados</h2>
                            <div class="contenForm">
                                <form class="formReport" method="POST" action="../report/reporteEstadoResultado.php?id_empresa=<?php echo $id_empresa ?>" target="_blank">
