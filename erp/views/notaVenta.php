...
<?php
    ...
    $sqlCliente = ("SELECT * FROM notas WHERE id_empresa_nota = $id_empresa AND tipo_nota = 'Venta' ORDER BY id_nota DESC");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="ImagenAutor">
                        <div>
                            <img class="FotoAutor"src="../img/notaVentas.png">
                        </div>
                        <div>
                            <h2 style="font-size:40px;position:relative;top:10px;" class="txtDichoAutor">Nota de Ventas</h2>
                        </div>
                ...
                <div class="card shadow mb-4" >
                    ...
                    <?php
                        ...
                        if(isset($_GET['enviar'])){
                            ...
                            $cantidad     = mysqli_num_rows($queryNota);?>
                                ...
                                //echo $iniciar;
                                //consulta
                                $sqlCliente   = ("SELECT * FROM notas WHERE id_empresa_nota = '$id_empresa' AND tipo_nota = 'Venta' ORDER BY id_nota DESC LIMIT $iniciar, 6");
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width:5rem;"><a style="background-color:#E34724" href="verNotaVenta.php?id=<?php echo $id_empresa;?>&id_nota=<?php echo $dataNota['id_nota'] ?>" class="btn btn-danger"><i style="font-size: 16px;" class="fa fa-eye"></a></td>
                        ...
                        <nav aria-label="Page navigation example" class="paginacion">
                            <ul class="pagination">
                                <li class="page-item <?php echo $_GET['paginas']<=1? 'disabled':''?>"">
                                    <a class="page-link" href="notaVenta.php?id=<?php echo $id_empresa?>&paginas=<?php echo $_GET['paginas']-1 ?>">
                                        Anterior
                                    </a>
                                </li>
                                ...
                                <li  class="page-item <?php echo $_GET['paginas']==$i+1 ? 'active' : '' ?>">
                                    <a style="background-color:#5a5c69; color:white;" class="page-link" href="notaVenta.php?id=<?php echo $id_empresa?>&paginas=<?php echo $i+1 ; ?>">
                                ...
                                <a class="page-link" href="notaVenta.php?id=<?php echo $id_empresa?>&paginas=<?php echo $_GET['paginas']+1 ?>" style="position: relative; left: 0;">
                                    Siguiente
                                    </a>
                                </li>
                            </ul>
